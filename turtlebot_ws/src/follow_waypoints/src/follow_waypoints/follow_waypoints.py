...
class FollowPath(State):
    ...
    def execute(self, userdata):
        ...
        for waypoint in waypoints:
            ...
            #self.poseArray_publisher = rospy.Publisher('/current_goal', goal, queue_size=5000) #publish current goal
            time.sleep(2)
        return 'success'
...
class GetPath(State):
    def __init__(self):
        ...
        self.poseArray_publisher = rospy.Publisher('/waypoints', PoseArray, queue_size=5000)
    ...
    def execute(self, userdata):
        ...
        topic = "/room_exploration/room_exploration_server/PoseStamped_path"
        #topic = "/initialpose"
