...
######################################################
    ...
    ##################################################### this initialises all PID velocity controls and subscribers/publishers
        ...
        self.ticks_per_meter = rospy.get_param('ticks_meter', 20666)
        ...
        rospy.Subscriber("Dmotor_pub", Int16, self.wheelCallback) #Subscribe to Wheel encoder
        rospy.Subscriber("Dwheel_vtarget", Float32, self.targetCallback) #Subscribe to twisttomotors vtargets
        self.pub_motor = rospy.Publisher('Dmotor_cmd',Float32, queue_size=10) #publish motor command to motor. is this 1 motor or 2?
        self.pub_vel = rospy.Publisher('Dwheel_vel', Float32, queue_size=10)  #publish wheel velocity to diff_tf
