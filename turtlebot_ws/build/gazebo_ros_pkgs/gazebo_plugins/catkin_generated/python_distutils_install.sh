...
echo_and_run cd "/home/jerom/turtlebot_ws/src/gazebo_ros_pkgs/gazebo_plugins"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/jerom/turtlebot_ws/build/gazebo_ros_pkgs/gazebo_plugins" \
    install \
    --root="${DESTDIR-/}" \
