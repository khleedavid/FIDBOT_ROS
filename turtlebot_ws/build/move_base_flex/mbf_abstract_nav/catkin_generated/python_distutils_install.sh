...
echo_and_run cd "/home/jerom/turtlebot_ws/src/move_base_flex/mbf_abstract_nav"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/jerom/turtlebot_ws/build/move_base_flex/mbf_abstract_nav" \
    install \
    --root="${DESTDIR-/}" \
