...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(MoveBaseFlexConfig::AbstractParamDescriptionConstPtr(new MoveBaseFlexConfig::ParamDescription<int>("controller_max_retries", "int", 0, "How many times we will recall the controller in an attempt to find a valid comand before giving up", "", &MoveBaseFlexConfig::controller_max_retries)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(MoveBaseFlexConfig::AbstractParamDescriptionConstPtr(new MoveBaseFlexConfig::ParamDescription<int>("controller_max_retries", "int", 0, "How many times we will recall the controller in an attempt to find a valid comand before giving up", "", &MoveBaseFlexConfig::controller_max_retries)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
