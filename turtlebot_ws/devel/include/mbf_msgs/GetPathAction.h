...
struct MD5Sum< ::mbf_msgs::GetPathAction_<ContainerAllocator> >
{
  ...
  {
    return "479a13997aa5d495506efa41e49397d1";
  }

  static const char* value(const ::mbf_msgs::GetPathAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x479a13997aa5d495ULL;
  static const uint64_t static_value2 = 0x506efa41e49397d1ULL;
};
