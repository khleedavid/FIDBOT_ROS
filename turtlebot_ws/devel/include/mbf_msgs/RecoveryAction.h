...
struct MD5Sum< ::mbf_msgs::RecoveryAction_<ContainerAllocator> >
{
  ...
  {
    return "3cf355c4c995f0cd4a2aac0d6ee9f4cd";
  }

  static const char* value(const ::mbf_msgs::RecoveryAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3cf355c4c995f0cdULL;
  static const uint64_t static_value2 = 0x4a2aac0d6ee9f4cdULL;
};
