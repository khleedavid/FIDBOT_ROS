...
if("TRUE" STREQUAL "TRUE")
  set(differential_drive_SOURCE_PREFIX /home/jerom/turtlebot_ws/src/differential_drive)
  set(differential_drive_DEVEL_PREFIX /home/jerom/turtlebot_ws/devel)
  ...
  set(differential_drive_INSTALL_PREFIX /home/jerom/turtlebot_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'differential_drive' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jerom/turtlebot_ws/src/differential_drive/${idir}'.  ${_report}")
    endif()
