...
class ExePathGoal(genpy.Message):
  _md5sum = "33ff17a095839640ba7e28c0dc858031"
...
float64 w
"""
  __slots__ = ['path','controller','concurrency_slot']
  _slot_types = ['nav_msgs/Path','string','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       path,controller,concurrency_slot
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.concurrency_slot))
